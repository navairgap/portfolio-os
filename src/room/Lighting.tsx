...
export default function Lighting({ screenPos }: { screenPos: [number, number, number] }) {
  ...
  return (<>
    ...
    <pointLight ref={lamp} position={[screenPos[0] + 0.7, screenPos[1] + 0.5, screenPos[2] + 0.4]} color="#ffb06b" intensity={30} distance={9} decay={2} castShadow shadow-mapSize={[1024, 1024]} />
